...
function startAnalytics(varConsent){
    Cookies.set('ga-disable-UA-175320409-1', false, { expires: 395 });
    // insertion de cette valeur dans l'objet window
    window['ga-disable-UA-175320409-1'] = false;
...
function stopAnalytics(varConsent){
    ...
    Cookies.set('ga-disable-UA-175320409-1', true, { expires: 395 });
    // insertion de cette valeur dans l'objet window
    window['ga-disable-UA-175320409-1'] = true;
