...
for file in *
  do
    ...
    csvsql --db mysql+mysqlconnector://root:@localhost:3306/cite --overwrite --tables $filename --insert $file --query "ALTER TABLE ${filename} ADD PRIMARY KEY (${firstcol}); ALTER TABLE ${filename} CHANGE ${firstcol} id INT AUTO_INCREMENT NOT NULL;  ALTER TABLE ${filename} DROP BASE;"
